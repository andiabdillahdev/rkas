    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
                <h2>Update Buku Pembantu Pajak</h2>
              <div class="clearfix"></div>
            </div>
            <div class="x_content">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="row text-center">
                      <button type="button" onclick="post_data_page('bendahara/buku-pembantu-pajak/update/{{$data['id']}}','Data Buku Pembantu Pajak','form_pembantu_pajakEdit','Update','tbl_pmb_pajak','bendahara/buku-pembantu-pajak')" class="btn btn-success">Submit</button>
...
@push('scriptSecond')
    <script>
        var status = {!! json_encode($data['status_transaksi']) !!}
