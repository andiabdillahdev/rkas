<form id="form_itemprogramedit" class="form-horizontal form-label-left">

    <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="main_program">Main Program<span class="required">*</span>
        </label>
        <div class="col-md-6 col-sm-6 col-xs-12">
            {{ Form::select('main_program', $main_program, $data['id_main'], ['class' => 'form-control','id'=>'main_program_form','title'=>'Pilih Main Program','onchange'=>'mainprogram_select("main_program_form")']) }} 
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {{ Form::select('sub_program', $sub,null, ['class' => 'form-control','id'=>'sub_program_form','title'=>'Pilih Sub Program']) }} 
        </div>
      </div>
...
<button type="button" class="btn btn-success button_modal" onclick="post_data('/komponen_data/itemprogram/update/{{$data['id']}}','Data Item Program','form_itemprogramedit','Update','tb_itemprogram')"> Save changes</button>
</div>