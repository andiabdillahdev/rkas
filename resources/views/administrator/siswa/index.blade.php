              ...
              <div class="" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <div id="myTabContent" class="tab-content">
                  <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                    <a role="button" class="btn btn-primary btn-sm" onclick="show_modal_add('Tambah Data Siswa','/siswa/create')"><i class="fa fa-plus-square"></i> Tambah Data</a>
                    <table id="tbl_siswa" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                              <th>No</th>
                                <th>Nama</th>
