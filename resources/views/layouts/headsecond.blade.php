        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <h2>{{ Auth::guard('bendahara')->user()->nama }}</h2>
              </div>
              <div class="clearfix"></div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href="{{ route('home') }}"><i class="fa fa-home"></i> Beranda </a>
                  ...
                  <li><a href="{{ route('bendahara.anggaran') }}"><i class="fa fa-money"></i> Kelola Anggaran </a>
                  </li>

                  <li><a href="{{ route('index.lpj') }}"><i class="fa fa-money"></i>  LPJ </a>
                  </li>


                  <li class=""><a><i class="fa fa-sitemap"></i>Data Kelengkapan LPJ<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="display: none;">
                        <li>
                           <a href="{{ route('kasUmum.home') }}">Buku Kas Umum</a>
                        </li>
                        <li><a href="{{ route('pmbBank.home') }}">Buku Pembantu Bank</a>
                        </li>
                        <li><a href="{{ route('pmbPajak.home') }}">Buku Pembantu Pajak</a>
                        </li>
                        {{-- <li><a href="#">Rekapitulasi Realisasi Penggunaan Dana Tiap Jenis Anggaran</a>
                        </li> --}}
                    </ul>
                  </li>

                  <li><a href="{{ route('bendahara.sekolah') }}"><i class="fa fa-money"></i> Data Sekolah </a>
                  </li>

                  <li><a href="{{ route('bendahara.pegawai') }}"><i class="fa fa-money"></i> Data Pegawai </a>
                  </li>

                  <li><a href="{{ route('bendahara.siswa') }}"><i class="fa fa-money"></i> Data Siswa </a>
                  </li>
            ...
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <img src="{{ asset('assets/images/img.jpg') }}" alt="">{{Auth::guard('bendahara')->user()->nama}}
