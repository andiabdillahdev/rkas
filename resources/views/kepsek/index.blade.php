    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Selamat Datang di Panel Kepala Sekolah </h2>
              <div class="clearfix"></div>
            </div>
            <div class="x_content">
              <div class="row tile_count">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                  <span class="count_top"><i class="fa fa-list"></i> LPJ</span>
                  <div class="count" id="totalTerkirim">1</div>
                </div>
            <!--     <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                  <span class="count_top"><i class="fa fa-list"></i> LPJ Di Tolak</span>
                  <div class="count" id="totalTolak"></div>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                  <span class="count_top"><i class="fa fa-list"></i> LPJ Valid</span>
